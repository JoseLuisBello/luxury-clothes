...
ALTER TABLE "HistorialEstadoPedido" ADD COLUMN "id_estado_envio" int4 DEFAULT NULL;
ALTER TABLE "HistorialEstadoPedido" ALTER COLUMN "id_estado_pedido" DROP NOT NULL;
ALTER TABLE "HistorialEstadoPedido" ADD FOREIGN KEY ("id_estado_envio") REFERENCES "EstadoEnvio"("id");
